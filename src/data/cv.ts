...
export const experience: Role[] = [
  {
    ...
    bullets: [
      ...
      'Built and maintained Games Analytics Home - an internal operational analytics dashboard serving studio leadership, product managers, and vertical leads with real-time performance metrics across engagement, retention, player states, and releases; integrated GenAI-powered studio summaries and a live assistant backed by Netflix GenAI platform, with role-based access control and multi-worker cache sharing across Titus deployment.',
