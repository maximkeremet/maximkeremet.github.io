...
export const experience: Role[] = [
  {
    ...
    bullets: [
      ...
      'Built and maintained Games Analytics Home - an internal analytics hub serving all leadership layers from game PMs and studio managers to vertical leads and Netflix Games President; provides a unified UI with reusable widget contracts and shared component library, surfacing game and studio performance metrics across engagement, retention, player states, and releases, with role-based access control scoped per stakeholder layer.',
